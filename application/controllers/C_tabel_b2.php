...
class C_tabel_b2 extends Omnitags
{
	...
	public function detail($code = null)
	{
		...
		$this->load_page('tabel_b2', '_layouts/template', $data1);
	}
	...
	public function laporan()
	{
		...
		$this->load_page('tabel_b2', '_layouts/printpage', $data1);
	}
	...
	public function history($code = null)
	{
		...
		$data1 = array(
			'table_id' => $code,
			'title' => lang('tabel_b2_alias_v11_title'),
	...
	public function push($code = null)
	{
		...
		// menggunakan nama khusus sama dengan konfigurasi
		$data = array(
			$this->aliases['tabel_b2_field1'] => $tabel[0]->{$this->aliases['tabel_b2_field1']},
		...
		$aksi = $this->tl_b2->update_b2($data, $tabel[0]->{$this->aliases['tabel_b2_field1']});
