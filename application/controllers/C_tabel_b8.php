...
class C_tabel_b8 extends Omnitags
{
	...
	public function detail_archive($param1 = null)
	{
		...
		$tabel = $this->tl_b8->get_b8_by_field('tabel_b8_field1', $param1)->result();
		$this->check_data($tabel);
		...
		$data1 = array(
			...
			'tbl_b8' => $this->tl_b8->get_b8_by_field_archive('tabel_b8_field1', $param1),
		);
	...
	public function history($param1 = null)
	{
		...
		$data1 = array(
			...
			'dekor' => $this->tl_b1->dekor($this->theme_id, $this->aliases['tabel_b8']),
			'tbl_b8' => $this->tl_ot->get_by_field_history('tabel_b8', 'tabel_b8_field1', $param1),
		);
	...
	public function push($code = null)
	{
		...
		// menggunakan nama khusus sama dengan konfigurasi
		$data = array(
			$this->aliases['tabel_b8_field1'] => $tabel[0]->{$this->aliases['tabel_b8_field1']},
		...
		$aksi = $this->tl_b8->update_b8($data, $tabel[0]->{$this->aliases['tabel_b8_field1']});
