...
class C_tabel_d4 extends Omnitags
{
	...
	public function history($param1 = null)
	{
		...
		$data1 = array(
			...
			'dekor' => $this->tl_b1->dekor($this->theme_id, $this->aliases['tabel_d4']),
			'tbl_d4' => $this->tl_ot->get_by_field_history('tabel_d4', 'tabel_d4_field1', $param1),
		);
	...
	public function push($code = null)
	{
		...
		// menggunakan nama khusus sama dengan konfigurasi
		$data = array(
			$this->aliases['tabel_d4_field1'] => $tabel[0]->{$this->aliases['tabel_d4_field1']},
		...
		$aksi = $this->tl_d4->update_d4($data, $tabel[0]->{$this->aliases['tabel_d4_field1']});
