...
class C_tabel_e5 extends Omnitags
{
	...
	// Soft Delete data
	public function restore($tabel_e5_field1 = null)
	{
		$this->declarew();
		$this->session_3();

		$tabel = $this->tl_e5->get_e5_by_field_archive('tabel_e5_field1', $tabel_e5_field1)->result();
		$this->check_data($tabel);
	...
	public function delete($tabel_e5_field1 = null)
	{
		...
		$tabel_e5 = $this->tl_e5->get_e5_by_field_archive('tabel_e5_field1', $tabel_e5_field1)->result();
		$this->check_data($tabel_e5);
	...
	public function push($code = null)
	{
		...
		// menggunakan nama khusus sama dengan konfigurasi
		$data = array(
			$this->aliases['tabel_e5_field1'] => $tabel[0]->{$this->aliases['tabel_e5_field1']},
		...
		$aksi = $this->tl_e5->update_e5($data, $tabel[0]->{$this->aliases['tabel_e5_field1']});
