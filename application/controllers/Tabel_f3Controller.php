...
class Tabel_f3Controller extends OmnitagsController
{
	...
	public function daftar()
	{
		...
		$data1 = array(
			'title' => $this->title['tabel_f3_alias_v2'],
	...
	public function daftar_history()
	{
		...
		$data1 = array(
			'title' => $this->title['tabel_f3_alias'],
	...
	public function admin()
	{
		...
		$data1 = array(
			'title' => $this->title['tabel_f3_alias_v3'],
	...
	public function laporan()
	{
		...
		$data1 = array(
			'title' => $this->title['tabel_f3_alias_v4'],
	...
	public function print($code = null)
	{
		...
		$data1 = array(
			'title' => $this->title['tabel_f3_alias_v5'],
	...
	public function archive()
	{
		...
		$data1 = array(
			'title' => $this->title['tabel_f3_alias_v9'],
	...
	public function detai_archive($code = null)
	{
		...
		$data1 = array(
			'title' => $this->title['tabel_f3_alias_v10'],
	...
	public function history($code = null)
	{
		...
		$data1 = array(
			'table_id' => $code,
			'title' => $this->title['tabel_f3_alias_v11'],
