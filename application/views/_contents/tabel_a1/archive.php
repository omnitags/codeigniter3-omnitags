...
<div id="card-view" class="data-view active">
  <div class="row">
    <?php if (empty($tbl_a1->result())) {
      ...
      $counter = 1;
      foreach ($tbl_a1->result() as $tl_a1):
        echo card_regular(
          $counter,
          $tl_a1->$tabel_a1_field1,
          $tl_a1->$tabel_a1_field1,
          $tl_a1->$tabel_a1_field2,
          btn_lihat($tl_a1->$tabel_a1_field1) . ' ' .
          btn_restore('tabel_a1', $tl_a1->$tabel_a1_field1) . ' ' .
          btn_hapus_full('tabel_a1', $tl_a1->$tabel_a1_field1),
  ...
  <table class="table table-light" id="data">
    ...
    <tbody>
      <?php foreach ($tbl_a1->result() as $tl_a1): ?>
        <tr>
          <td></td>
          <td><?= $tl_a1->$tabel_a1_field1; ?></td>
          <td><?= $tl_a1->$tabel_a1_field2 ?></td>
          <td>
            <?= btn_lihat($tl_a1->$tabel_a1_field1) ?>
            <?= btn_restore('tabel_a1', $tl_a1->$tabel_a1_field1) ?>
            <?= btn_hapus_full('tabel_a1', $tl_a1->$tabel_a1_field1) ?>
...
<!-- modal edit-->
<?php foreach ($tbl_a1->result() as $tl_a1): ?>
  <div id="lihat<?= $tl_a1->$tabel_a1_field1; ?>" class="modal fade lihat" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <?= modal_header_id(lang('tabel_a1_alias'), $tl_a1->$tabel_a1_field1) ?>
...
<?= load_card_pagination_js($tbl_a1->num_rows(), 28) ?>