    ...
    <tbody>
      ...
      <?php foreach ($tbl_a1_alt->result() as $tl_a1): ?>
        <tr>
          ...
          <td><?= $tl_a1->updated_at ?></td>
          <td><?= show_info_user($tl_a1->updated_by, $users) ?></td>
          <td>
  ...
  <div id="lihat<?= $tl_a1->id_history; ?>" class="modal fade lihat" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <?= modal_header_id(lang('tabel_a1_alias'), $tl_a1->id_history) ?>
        ...
        <form>
          ...
          <div class="modal-footer">
            <?= btn_push('tabel_a1', $tl_a1->id_history) ?>
            <?= btn_tutup() ?>
          </div>
        </form>
