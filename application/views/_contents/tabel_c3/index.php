...
<?php foreach ($tbl_c3->result() as $tl_c3): ?>
  <div class="row mb-5">
    <div class="col-md-6">
      <img src="img/<?= $tabel_c3 ?>/<?= $tl_c3->$tabel_c3_field3 ?>" class="img-fluid rounded">

    </div>
    <div class="col-md-6">
      <h2 class="pt-2"><?= $tl_c3->$tabel_c3_field2; ?></h2>
      <ul class="list-unstyled ml-2">
        <li><?= $tabel_e2_alias ?> : </li>
        <?php foreach ($tbl_e2->result() as $tl_e2): ?>
          <?php if ($tl_c3->$tabel_c3_field1 === $tl_e2->$tabel_c3_field1) { ?>
