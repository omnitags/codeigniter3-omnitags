...
<div id="card-view" class="data-view active">
  <div class="row">
    <?php if (empty($tbl_f4->result())) {
      load_view('_partials/no_data');
    } else {
      $counter = 1;
      foreach ($tbl_f4->result() as $tl_f4):
        echo card_regular(
          $counter,
          $tl_f4->$tabel_f4_field1,
          $tl_f4->$tabel_f4_field1,
          $tl_f4->$tabel_f4_field2,
          btn_lihat($tl_f4->$tabel_f4_field1) . ' ' .
          btn_restore('tabel_f4', $tl_f4->$tabel_f4_field1) . ' ' .
          btn_hapus_full('tabel_f4', $tl_f4->$tabel_f4_field1),
...
<?= load_card_pagination_js($tbl_f4->num_rows(), 28) ?>