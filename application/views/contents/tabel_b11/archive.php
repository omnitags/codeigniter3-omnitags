...
<div id="card-view" class="data-view active">
  <div class="row">
    <?php if (empty($tbl_b11->result())) {
      load_view('partials/no_data');
    } else {
      $counter = 1;
      foreach ($tbl_b11->result() as $tl_b11):
        echo card_regular(
          $counter,
          $tl_b11->$tabel_b11_field1,
          $tl_b11->$tabel_b11_field1,
          $tl_b11->$tabel_b11_field2,
          btn_lihat($tl_b11->$tabel_b11_field1) . ' ' .
          btn_restore('tabel_b11', $tl_b11->$tabel_b11_field1) . ' ' .
          btn_hapus_full('tabel_b11', $tl_b11->$tabel_b11_field1),
      ...
      <div class="modal-content">
        ...
        <form>
          ...
          <div class="modal-footer">
            <?= btn_history('tabel_b11', $tl_b11->$tabel_b11_field1) ?>
            <?= btn_tutup() ?>
          </div>
        </form>
...
<?= load_card_pagination_js($tbl_b11->num_rows(), 28) ?>