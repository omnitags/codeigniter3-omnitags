  ...
  <table class="table">
    <thead class="thead">
      <tr>
        ...
        <th><?= $tabel_e6_field3_alias ?></th>
        <th><?= $tabel_e6_field4_alias ?></th>
        <th><?= $tabel_e6_field5_alias ?></th>
        <th><?= $tabel_e6_field6_alias ?></th>
      </tr>
      </tr>
    </thead>
    <tbody>
    ...
    <thead class="thead">
      <tr>
        <th><?= $tabel_e6_field7_alias ?></th>
        <th><?= $tabel_e6_field8_alias ?></th>
        <th><?= $tabel_e6_field9_alias ?></th>
        <th><?= $tabel_e6_field10_alias ?></th>
        <th><?= $tabel_e6_field11_alias ?></th>
        <th><?= $tabel_e6_field12_alias ?></th>
        <th><?= $tabel_e6_field13_alias ?></th>
      </tr>
      </tr>
    </thead>
    <tbody>
