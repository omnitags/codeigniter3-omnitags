    ...
    <?php if (empty($tbl_f1->result())) {
      ...
      foreach ($tbl_f1->result() as $tl_f1):
        echo card_regular(
          ...
          $tl_f1->$tabel_f1_field1,
          $tl_f1->$tabel_f1_field2,
          btn_lihat($tl_f1->$tabel_f1_field1) . ' ' .
          btn_restore('tabel_f1', $tl_f1->$tabel_f1_field1) . ' ' .
          btn_hapus_full('tabel_f1', $tl_f1->$tabel_f1_field1),
...
<!-- modal edit-->
<?php foreach ($tbl_f1->result() as $tl_f1): ?>
  <div id="lihat<?= $tl_f1->$tabel_f1_field1; ?>" class="modal fade lihat" role="dialog">
      ...
      <div class="modal-content">
        ...
        <form>
          ...
          <div class="modal-footer">
            <?= btn_history('tabel_f1', $tl_f1->$tabel_f1_field1) ?>
            <?= btn_tutup() ?>
          </div>
        </form>
...
<?= load_card_pagination_js($tbl_f1->num_rows(), 28) ?>