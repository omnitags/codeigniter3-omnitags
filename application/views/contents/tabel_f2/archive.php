    ...
    <?php if (empty($tbl_f2->result())) {
      ...
      foreach ($tbl_f2->result() as $tl_f2):
        echo card_regular(
          ...
          $tl_f2->$tabel_f2_field1,
          $tl_f2->$tabel_f2_field2,
          btn_lihat($tl_f2->$tabel_f2_field1) . ' ' .
          btn_restore('tabel_f2', $tl_f2->$tabel_f2_field1) . ' ' .
          btn_hapus_full('tabel_f2', $tl_f2->$tabel_f2_field1),
      ...
      <div class="modal-content">
        ...
        <form>
          ...
          <div class="modal-footer">
            <?= btn_history('tabel_f2', $tl_f2->$tabel_f2_field1) ?>
            <?= btn_tutup() ?>
          </div>
        </form>
