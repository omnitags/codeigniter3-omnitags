    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        <select class="form-control float" required name="<?= $tabel_e4_field1_input ?>">
          <option selected hidden value="">Select <?= $tabel_e4_field2_alias ?>...</option>
      ...
      <!-- keterangan * -->
      <small>*<?= $tabel_f2_field4_alias . ' are required to do ' . $tabel_f2_alias . ' and ' . $tabel_f3_alias ?></small>
