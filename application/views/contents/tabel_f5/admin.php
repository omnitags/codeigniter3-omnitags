    ...
    <tbody>
      <?php foreach ($tbl_f5->result() as $tl_f5): ?>
        <tr>
          ...
          <td><?= $tl_f5->$tabel_f5_field4 ?></td>
          <td><?= $tl_f5->$tabel_f5_field5 ?></td>
          <td><?= $tl_f5->$tabel_f5_field6 ?></td>
          <td> <?= btn_lihat($tl_f5->$tabel_f5_field1) ?>
            <?= btn_hapus('tabel_f5', $tl_f5->$tabel_f5_field1) ?>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
  ...
  <div id="lihat<?= $tl_f5->$tabel_f5_field1; ?>" class="modal fade lihat" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <?= modal_header_id($tabel_f5_alias, $tl_f5->$tabel_f5_field1) ?>
        ...
        <form>
            ...
            <div class="row">
              <div class="col-md-6">
                <?= table_data(
                  ...
                  row_data('tabel_f5_field3', $tl_f5->$tabel_f5_field3),
                  'table-ligjt'
                ) ?>
              </div>
              <div class="col-md-6">
                <?= table_data(
                  row_data('tabel_f5_field4', $tl_f5->$tabel_f5_field4) .
                  row_data('tabel_f5_field5', $tl_f5->$tabel_f5_field5) .
                  row_data('tabel_f5_field6', $tl_f5->$tabel_f5_field6),
                  'table-ligjt'
                ) ?>
              </div>
            </div>
          ...
          <div class="modal-footer">
            <?= btn_history('tabel_f5', $tl_f5->$tabel_f5_field1) ?>
            <?= btn_tutup() ?>
          </div>
        </form>
