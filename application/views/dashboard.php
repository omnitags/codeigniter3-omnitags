...
<?php switch (userdata($tabel_c2_field6)) {
  case $tabel_c2_field6_value3: ?>
    <div class="row">
      <?= card_count($tabel_c2_alias, 'tabel_c2', 'text-white bg-danger', $tbl_c2) ?>
      <!-- ?= card_count($tabel_c1_alias, 'tabel_c1', 'text-white bg-danger', $tbl_c1) ?> -->
      <?= card_count($tabel_d3_alias, 'tabel_d3', 'text-white bg-danger', $tbl_d3) ?>
...
<div class="row">
  ...
  <?php switch (userdata($tabel_c2_field6)) {
    ...
    case $tabel_c2_field6_value2: ?>
      <!-- ?= card_count($tabel_f3_alias, 'tabel_f3', 'text-white bg-danger', $tbl_f3) ?> -->
      <?php break;
