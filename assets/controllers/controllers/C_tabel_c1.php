...
class C_tabel_c1 extends Omnitags
{
	...
	public function profil()
	{
		...
		$tabel_c1_field1 = $this->session->userdata($this->aliases['tabel_c2_field1']);
		$data1 = array(
	...
	public function ceklogin()
	{
		...
		$tabel_c1_field3 = $this->v_post['tabel_c1_field3'];
		$param8 = $this->v_post['tabel_c1_field4'];

		$method1 = $this->tl_c1->cek_tabel_c1_field3($tabel_c1_field3);
		...
		if ($method1->num_rows() > 0) {
			...
			if (password_verify($param8, $method8)) {
				$tabel_c2_field1 = $tabel_c1[0]->id_pemilik;
				$tabel_c2_field2 = $tabel_c1[0]->nama;
				$tabel_c2_field3 = $tabel_c1[0]->email;
				$tabel_c2_field4 = $tabel_c1[0]->hp;
				...
				$this->session->set_userdata($this->aliases['tabel_c2_field4'], $tabel_c2_field4);
				// $this->session->set_userdata($this->aliases['tabel_c1_field6'], $tabel_c1_field6);
